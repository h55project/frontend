...
class GuardianConfiguration extends Logging {
  ...
  object commercial {
    ...
    lazy val dfpInlineMerchandisingTagsDataKey = s"$dfpRoot/inline-merchandising-tags.json"
    lazy val dfpHighMerchandisingTagsDataKey = s"$dfpRoot/high-merchandising-tags.json"
    lazy val dfpPageSkinnedAdUnitsKey = s"$dfpRoot/pageskinned-adunits.json"
    ...
    lazy val dfpOrdersKey = s"$dfpRoot/orders.json"
